    ...
    <div class="admin-wrapper " id="admin-wrapper">
        ...
        <main class="admin-main">
            <div class="container-fluid p-4 p-lg-5">
                @if(session('toast'))
                <div id="toast-notification" class="toast-notification {{ session('toast.type') }}">
                    <i class="bi 
        @if(session('toast.type') == 'success') bi-check-circle
        @elseif(session('toast.type') == 'error') bi-x-circle
        @elseif(session('toast.type') == 'info') bi-info-circle
        @elseif(session('toast.type') == 'warning') bi-exclamation-triangle
        @endif
    "></i>
        ...
        $(document).ready(function() {
            $('.statistics').DataTable({
                ...
                columnDefs: [{
                        orderable: false,
                        targets: 0
                    } // birinchi ustunni tartiblashni o'chiramiz
                ],
                language: {
                    search: "Qidirish:",
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (toast) {
                ...
                // 4 sekunddan keyin butunlay o‘chadi
